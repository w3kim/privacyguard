...
import com.PrivacyGuard.UI.ActionReceiver;
import com.PrivacyGuard.UI.DetailsActivity;
import com.PrivacyGuard.UI.Notifications;
import com.PrivacyGuard.UI.R;
import com.PrivacyGuard.UI.TunReadThread;
import com.PrivacyGuard.UI.TunWriteThread;
...
import com.PrivacyGuard.Utilities.Resolver.MyClientResolver;
import com.PrivacyGuard.Utilities.Resolver.MyNetworkHostNameResolver;
...
public class MyVpnService extends VpnService implements Runnable, Notifications {
  ...
  public void updateNotification(String appName, String msg){
    ...
    db.addDataLeak(new DataLeak(notifyId, appName, msg, events.length, dateFormat.format(new Date())));
